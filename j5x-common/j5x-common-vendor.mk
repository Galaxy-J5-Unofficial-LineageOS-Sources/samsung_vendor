...
PRODUCT_COPY_FILES += \
    vendor/samsung/j5x-common/proprietary/vendor/bin/qseecomd:$(TARGET_COPY_OUT_VENDOR)/bin/qseecomd \
    vendor/samsung/j5x-common/proprietary/vendor/etc/Bluetooth_cal.acdb:$(TARGET_COPY_OUT_VENDOR)/etc/Bluetooth_cal.acdb \
    vendor/samsung/j5x-common/proprietary/vendor/etc/D05QL_s5k5e3yx_module_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/D05QL_s5k5e3yx_module_info.xml \
    vendor/samsung/j5x-common/proprietary/vendor/etc/General_cal.acdb:$(TARGET_COPY_OUT_VENDOR)/etc/General_cal.acdb \
    vendor/samsung/j5x-common/proprietary/vendor/etc/Global_cal.acdb:$(TARGET_COPY_OUT_VENDOR)/etc/Global_cal.acdb \
    ...
    vendor/samsung/j5x-common/proprietary/vendor/lib/libTsAf.so:$(TARGET_COPY_OUT_VENDOR)/lib/libTsAf.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libaec_algo_front.so:$(TARGET_COPY_OUT_VENDOR)/lib/libaec_algo_front.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libaec_algo_rear.so:$(TARGET_COPY_OUT_VENDOR)/lib/libaec_algo_rear.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libaf_algo_rear.so:$(TARGET_COPY_OUT_VENDOR)/lib/libaf_algo_rear.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libawb_algo_front_al.so:$(TARGET_COPY_OUT_VENDOR)/lib/libawb_algo_front_al.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libawb_algo_rear_al.so:$(TARGET_COPY_OUT_VENDOR)/lib/libawb_algo_rear_al.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_1080p_b.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_1080p_b.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_1080p_s.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_1080p_s.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_res0.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_res0.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_res1.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_res1.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_res2.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_res2.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_common_res3.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_common_res3.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_default_video.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_default_video.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_hfr_1080p_b.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_hfr_1080p_b.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_hfr_1080p_s.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_hfr_1080p_s.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_hfr_120.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_hfr_120.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_liveshot.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_liveshot.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_panorama.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_panorama.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_preview.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_preview.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_snapshot.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_snapshot.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_uhd_video.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_uhd_video.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libchromatix_s5k3l2xx_zslshot.so:$(TARGET_COPY_OUT_VENDOR)/lib/libchromatix_s5k3l2xx_zslshot.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libmmcamera2_stats_algorithm.so:$(TARGET_COPY_OUT_VENDOR)/lib/libmmcamera2_stats_algorithm.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libmmcamera_cac2_lib_13M.so:$(TARGET_COPY_OUT_VENDOR)/lib/libmmcamera_cac2_lib_13M.so \
    vendor/samsung/j5x-common/proprietary/vendor/lib/libmmcamera_wavelet_lib.so:$(TARGET_COPY_OUT_VENDOR)/lib/libmmcamera_wavelet_lib.so \
